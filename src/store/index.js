...
export default new Vuex.Store({
  state: {
    ...
    slidePic: [{
      ...
      info: [{
          ...
          description: "innisfree is a natural brand that delivers the benefits of nature coming from the pristine JEJU island for your healthy beauty.",
        },
        {
      ...
      title: {
        title: "Dining",
        description: "Be a #LPFoodie! Explore over 40 food & bevarge outlets in Langham Place."
      },
      info: [{
      ...
      title: {
        title: "Shopping",
        description: "Create your own style! Check out the hottest fashion & beauty brands in town."
      },
      info: [{
          link: require("../assets/img/slidePic5.jpg"),
          picName: "slidePic5",
  ...
  actions: {
    setWindowWidth: (({ //增加或是後退一週
      commit
    }, width) => {
      commit('setWindowWidth', width);
    }),
    setListClose: (({ //增加或是後退一週
      commit
    }, bool) => {
